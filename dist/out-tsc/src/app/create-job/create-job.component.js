...
var CreateJobComponent = /** @class */ (function () {
    function CreateJobComponent(serverRouter) {
    ...
    /*
      ----- HELPER FUNCTIONS ------
    */
    CreateJobComponent.prototype.selectFile = function () {
    ...
    CreateJobComponent.prototype.selectTool = function () {
    ...
    CreateJobComponent.prototype.selectCommand = function () {
        var select = (document.getElementById("toolSelect"));
        ;
        var value = select.selectedIndex;
        if (value != 0) {
    ...
    */
    CreateJobComponent.prototype.cancelStage = function () {
        this.activeTool = null;
        this.activeCommand = null;
        this.activeWindow = "Job Receipt";
    };
    CreateJobComponent.prototype.switchAddStage = function () {
    ...
    CreateJobComponent.prototype.switchConfirmTool = function () {
    ...
    CreateJobComponent.prototype.switchConfirmTemplate = function () {
        if (this.activeTool != null) {
            this.toolError = null;
            this.activeWindow = "Stage Configure";
        }
    ...
    CreateJobComponent.prototype.switchConfirmStage = function () {
        // Command Set
        if (this.activeCommand == null) {
            ...
            for (var x = 0; x < this.activeCommand.requiredArguments.length; x++) {
                ...
                var selectedOption = document.getElementById('requiredOptionSelect' + argument.argument);
            ...
            for (var x = 0; x < this.activeCommand.optionalArguments.length; x++) {
                ...
                var selectedOption = document.getElementById('optionalOptionSelect' + argument.argument);
                if (selectedOption.selectedIndex != 0) {
                    var finalOption;
    ...
    CreateJobComponent.prototype.checkDependencies = function () {
        ...
        for (var i = 0; i < this.activeCommand.requiredArguments.length; i++) {
            ...
            if (argument.dependencies != null) {
                var argumentOption = (document.getElementById('requiredOptionSelect' + argument.argument));
                    ...
                    for (var dependency in argument.dependencies) {
                        for (var x = 0; x < this.activeCommand.requiredArguments.length; x++) {
                            ...
                            if (dependency == argToCheck.argument) {
                                argumentOption = (document.getElementById('requiredOptionSelect' + argToCheck.argument));
                                if (argumentOption.selectedIndex == 0) {
                                    return false;
                                }
                            }
                        ...
                        for (var x = 0; x < this.activeCommand.optionalArguments.length; x++) {
                            ...
                            if (dependency == argToCheck.argument) {
                                argumentOption = (document.getElementById('optionalOptionSelect' + argToCheck.argument));
                                if (argumentOption.selectedIndex == 0) {
                                    return false;
                                }
                            }
        ...
        for (var i = 0; i < this.activeCommand.optionalArguments.length; i++) {
            ...
            if (argument.dependencies != null) {
                var argumentOption = (document.getElementById('optionalOptionSelect' + argument.argument));
    ...
    CreateJobComponent.prototype.checkConflicting = function () {
    ...
    CreateJobComponent.prototype.checkFileType = function (tool) {
    ...
    CreateJobComponent.prototype.submitJobs = function () {
        if (this.jobStages.length == 0) {
            ...
            this.serverRouter.post('jobs/create', sendItems).then(function (response) {
                console.log('Success!');
                console.log(response['message']);
            });
        }
    };
    CreateJobComponent.prototype.removeStage = function (i) {
        this.jobStages.splice(i, 2);
    };
    CreateJobComponent.prototype.getFiles = function () {
        var _this = this;
        var token = localStorage.getItem('access_token');
        var sendItems = {
            token: token,
...
//# sourceMappingURL=create-job.component.js.map